            ...
            editorInstance.current = new EditorJS({
                ...
                tools: {
                    ...
                    image: {
                        ...
                        config: {
                            endpoints: {
                                byFile: "http://localhost:5000/api/tasks/upload-image", // Correct backend API for image uploads
                                byUrl: "http://localhost:5000/api/tasks/fetch-image", // Optional: Change this to a valid image-fetching API if needed
                            },
                            field: "image", // Ensure this matches the key in the FormData backend expects
                            types: "image/*", // Restrict file types to images
                        },
                    },
                },
                onChange: async () => {
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="bg-white">
                    <div id="editorjs" className="border rounded px-3 py-2 mt-1"></div>
                </div>
